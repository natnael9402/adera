...
async function runProductMigration(options = {}) {
  ...
  console.log(`📦 Generated ${items.length} unique interleaved products across 12 categories.`);
  ...
  return { insertedCount, updatedCount: 0, total };
}
