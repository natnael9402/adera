      ...
      case 'BRONZE':
        return (
          <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-md select-none">
            ...
            <circle cx="50" cy="50" r="47" fill="url(#bronzeRim)" filter="url(#bronzeGlow)" />
            ...
            <circle cx="50" cy="50" r="35" fill="url(#bronzeCenter)" />
      ...
      case 'SILVER':
        return (
          <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-md select-none">
            ...
            {/* Outer Silver Ring */}
            <circle cx="50" cy="50" r="47" fill="url(#silverRim)" filter="url(#silverGlow)" />
            ...
            <circle cx="50" cy="50" r="35" fill="url(#silverCenter)" />
      ...
      case 'GOLD':
        return (
          <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-md select-none">
            ...
            <circle cx="50" cy="50" r="47" fill="url(#goldRim)" filter="url(#goldGlow)" />
            ...
            <circle cx="50" cy="50" r="35" fill="url(#goldCenter)" />
        ...
        return (
          <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-md select-none">
            <defs>
              ...
              <linearGradient id="platCenter" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" stopColor="#ffffff" />
            ...
            <circle cx="50" cy="50" r="47" fill="url(#platRim)" filter="url(#platGlow)" />
            ...
            <circle cx="50" cy="50" r="35" fill="url(#platCenter)" />
