...
import { 
  UploadCloud, Image as ImageIcon, X, CheckCircle2, AlertCircle, 
  Loader2, Link as LinkIcon, RefreshCw, Eye, Check, 
  Info, Maximize2, ShieldCheck, Grid3X3
} from 'lucide-react';
...
export default function ImageUploadGuide({
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
        <div>
          ...
          <span className="text-[11px] text-slate-500">
            High-resolution cover image displayed on public causes & portals.
          </span>
        </div>
        ...
        >
          ...
          {isUploading && (
            <div className="absolute inset-0 z-40 bg-slate-950/70 backdrop-blur-xs flex flex-col items-center justify-center text-white gap-2">
              ...
              <p className="text-xs font-bold">Uploading Cover Image...</p>
            </div>
          )}
          ...
          {value ? (
            ...
            <>
              ...
              <div className="absolute top-3 left-3 z-20 flex items-center gap-1.5 bg-slate-950/80 backdrop-blur-md text-white text-[10px] font-bold px-2.5 py-1 rounded-lg border border-white/10 shadow-sm">
                ...
                <span>16:9 Display Frame</span>
              </div>

              {/* Bottom Quick Controls Bar */}
              <div className="absolute inset-x-0 bottom-0 z-20 p-2.5 sm:p-3 bg-slate-950/85 backdrop-blur-xs border-t border-slate-800 flex flex-wrap sm:flex-nowrap items-center justify-between gap-2 transition-opacity">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 text-[11px]">
          ...
          <div className="p-2.5 bg-white rounded-xl border border-slate-200 space-y-1">
            ...
            <p className="text-slate-500 leading-normal">
              Optimal: <strong>1200 × 675px</strong> or <strong>1920 × 1080px</strong>. Landscape orientation ensures clean display on hero banners and cards.
            </p>
          </div>
          ...
          <div className="p-2.5 bg-white rounded-xl border border-slate-200 space-y-1">
            ...
            <p className="text-slate-500 leading-normal">
              Use authentic, high-definition photos of the actual beneficiaries, facility, or community project in natural light.
            </p>
          </div>
          ...
          <div className="p-2.5 bg-white rounded-xl border border-slate-200 space-y-1">
            ...
            <p className="text-slate-500 leading-normal">
              Avoid vertical screenshots, low-resolution pixelated images, watermarks, or cluttered text overlays.
            </p>
          </div>
      ...
      {/* ========================================================================= */}
      {/* OPTIONAL ARCHIVE SAMPLES DRAWER                                            */}
      {/* ========================================================================= */}
      {showPresetsDrawer && (
