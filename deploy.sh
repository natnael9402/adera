...
echo " - Main Frontend:  http://localhost:12000"
echo " - Backend API:    http://localhost:12001"
echo " - Admin Console:  http://localhost:12002"
echo " - Impact Store:   http://localhost:12003"
echo " - PostgreSQL:     localhost:12432"
echo ""
echo "========================================================="
